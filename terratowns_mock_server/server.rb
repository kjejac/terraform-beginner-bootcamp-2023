...
# Actions
  ...
  post '/api/u/:user_uuid/homes' do
    ...
    # puts will print to the terminal similar to a print or concole.log
    puts "# create - POST /api/homes"

    # a begin/rescue is a try/catch, if an error occurs, rescue it.
    begin
      # Sinatra does not automatically parse json bodys as parameters
    ...
    # Creat a new Home model and set to attributes
    home = Home.new
    home.town = town
    home.name = name
    ...
    # return the errors
    unless home.valid?
      # return the error massage back as json
    ...
    puts "uuid #{uuid}"
    # will mock or data to our mock database
  ...
  put '/api/u/:user_uuid/homes/:uuid' do
    ...
    #home.domain_name = domain_name
    home.content_version = content_version
    #binding.pry #debuger, use console to see variables
